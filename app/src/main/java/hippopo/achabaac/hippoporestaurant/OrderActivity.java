...
public class OrderActivity extends AppCompatActivity {
    ...
    private void chooseItem(String strFood) {
        ...
        objBuilder.setSingleChoiceItems(objCharSequences, -1, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                itemString = Integer.toString(i + 1);   // +1 เพื่อให้ทราบจำนวนจาน
    ...
    private void postNewOrder() {
        ...
        //ทำ try เพื่อลดการ error

        try {
            //อัพขึ้น MySQL ได้

            ArrayList<NameValuePair> objNameValuePairs = new ArrayList<NameValuePair>();    //Apache
